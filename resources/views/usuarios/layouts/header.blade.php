                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-5 text-md-right text-center">
                                        <ul class="list-unstyled social-icon social mb-0 mt-4">
                                            <li class="list-inline-item"><a href="javascript:void(0)" class="rounded"  data-toggle="modal" data-target="#familiar"><i data-feather="user-plus" class="fea icon-sm fea-social"></i></a></li>
                                            ...
                                            <li class="list-inline-item"><a href="{{route('opciones')}}" class="rounded" data-toggle="tooltip" data-placement="bottom" title="Opciones"><i data-feather="tool" class="fea icon-sm fea-social"></i></a></li>
                                        </ul><!--end icon-->
                                    </div><!--end col-->
                                </div><!--end row-->
                            </div><!--end col-->
