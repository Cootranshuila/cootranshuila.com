                ...
                <table class="row" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" style="border-radius: 10px 10px 0 0;">
                    ...
                    <tr>
                        <th class="column" width="640" style="padding-left: 30px; padding-right: 30px; text-align: left;">
                            <a href="https://cootranshuila.com/" style="text-decoration: none;">
                                <img class="mobile-center" src="https://www.cootranshuila.com/assets/images/logo.png" width="300" alt="Header Logo" style="border: 0; width: 100%; max-width: 300px; margin:auto;">
                            </a>
                        </th>
                    </tr>
                    <tr>
                            ...
                            <table class="row" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <th class="column" width="640" style="text-align: left;">
                                        <div class="serif" style="color: #1F2225; font-size: 28px; font-weight: 700; line-height: 50px; margin-bottom: 15px;">Hola Jhon,</div>
                                        <div class="sans-serif" style="color: #969AA1; font-size: 18px; font-weight: 400; line-height: 28px; margin-bottom: 50px;">Mensaje enviado desde la pagina web</div>
                                    </th>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <th class="column" width="310" style="padding-right: 10px; color: #969AA1; font-size: 13px; font-weight: 400; text-align: left;">
                                        ...
                                        <div class="sans-serif" style="font-size: 14px;">
                                            <span style="font-weight: bold">Nombre:</span> <br> {{$contacto['nombre']}} <br>
                                            <br><span style="font-weight: bold">Correo:</span> <br> {{$contacto['correo']}} <br>
                                            <br><span style="font-weight: bold">Asunto:</span> <br> {{$contacto['asunto']}} <br>
                                            <br><span style="font-weight: bold">Mensaje:</span> <br> {{$contacto['mensaje']}}
                                        </div>
                            ...
                            <table class="row" cellpadding="0" cellspacing="0">
                                <tr valign="top" style="vertical-align: top;">
                                    <th class="column mobile-padding-bottom" width="255" style="padding-top: 10px; padding-right: 10px; text-align: left;">
                                        <a href="https://cootranshuila.com/">
                                            <img src="https://www.cootranshuila.com/assets/images/logo2.png" width="150" alt="Footer Logo" style="border: 0; width: 100%; max-width: 150px;">
                                        </a>
                                    </th>
                                        ...
                                        <table align="right" class="mobile-left" cellpadding="10" cellspacing="0">
                                            <tr>
                                                <td style="padding-left: 0;">
                                                    <a href="https://www.instagram.com/cootranshuila/" style="text-decoration: none;">
                                                ...
                                                <td>
                                                    <a href="https://www.facebook.com/cootranshuilaltdaoficial/" style="text-decoration: none;">
                            ...
                            <table class="row" cellpadding="0" cellspacing="0">
                                <tr valign="top" style="vertical-align: top;">
                                    <th class="column mobile-12" width="200" style="padding-right: 10px; color: #969AA1; font-weight: 400; text-align: left;">
                                        <div class="sans-serif" style="font-size: 14px; text-align: justify; font-weight: 700; margin-bottom: 15px;">Cootranshuila ltda</div>
                                        <div class="sans-serif" style="font-size: 12px; text-align: justify;">
                                            Nuestra más alta prioridad es el cliente para quien tenemos nuestra mejor actitud de servicio, el cliente es la razón de ser de nuestro trabajo; le servimos con gusto en forma amable y eficiente; nuestro potencial mas valioso es nuestra gente y la capacidad de trabajar en equipo.
                                        </div>
                                    </th>
                                </tr>
                            </table>
                            ...
                            <table class="row" cellpadding="0" cellspacing="0">
                                <tr>
                                    <th class="column" width="640" style="color: #969AA1; font-weight: 400; text-align: center;">
                                        <div class="sans-serif">Cootranshuila ltda. &copy;
                                            <script>
                                                n = new Date();
                                                y = n.getFullYear();
                                                document.write(y);
