...
@section('title')Encomiendas @endsection
        ...
        <div class="container mt-100 mt-60">
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-6">
                    <img src="{{asset('assets/images/encomiendas/encomiendas.jpeg')}}" class="img-fluid rounded shadow-md" alt="" width="445">
                </div><!--end col-->

                <div class="col-lg-7 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <div class="section-title ml-lg-4">
                        <h4 class="title mb-4">Trasnporte terrestre de encomiendas</h4>
                        <p class="text-muted">Prestamos los servicios de carga en todo el país a:</p>
                        <ul class="list-unstyled text-muted">
                            <li class="mb-0"><span class="text-primary h5 mr-2"><i class="uim uim-check-circle"></i></span>Personas naturales.</li>
                            <li class="mb-0"><span class="text-primary h5 mr-2"><i class="uim uim-check-circle"></i></span>Convenios Institucionales.</li>
                            <li class="mb-0"><span class="text-primary h5 mr-2"><i class="uim uim-check-circle"></i></span>Recogida en ciudades principales.</li>
                        </ul>
                        <p class="text-muted">Modalidades del servicio de carga:</p>
                        <ul class="list-unstyled text-muted">
                            <li class="mb-0"><span class="text-primary h5 mr-2"><i class="uim uim-check-circle"></i></span>Contado.</li>
