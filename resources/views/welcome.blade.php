            ...
            <div class="row justify-content-center">
                <div class="col-xl-3 col-lg-4 col-md-6 col-12 mt-4 pt-2">
                    <div class="bg-white features explore-feature servicios_index p-4 pt-5 px-md-3 border-0 rounded-md shadow text-center">
                        ...
                        <div class="card-body p-0 content">
                            ...
                            <a href="javascript:void(0)" class="text-primary">Proximamente <i data-feather="chevron-right" class="fea icon-sm"></i></a>
                        </div>
                    </div>
                </div><!--end col-->
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-12 mt-4 pt-2">
                    <div class="bg-white features explore-feature servicios_index p-4 pt-5 px-md-3 border-0 rounded-md shadow text-center">
                        ...
                        <div class="card-body p-0 content">
                            <h5 class="mt-4"><a href="{{route('flota')}}" class="title text-dark">Muestra Flota</a></h5>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-12 mt-4 pt-2">
                    <div class="bg-white features explore-feature servicios_index p-4 pt-5 px-md-3 border-0 rounded-md shadow text-center">
                        ...
                        <div class="card-body p-0 content">
                            <h5 class="mt-4"><a href="{{route('encomiendas')}}" class="title text-dark">Carga y Encomiendas</a></h5>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-12 mt-4 pt-2">
                    <div class="bg-white features explore-feature servicios_index p-4 pt-5 px-md-3 border-0 rounded-md shadow text-center">
                        ...
                        <div class="card-body p-0 content">
                            <h5 class="mt-4"><a href="https://cootranshuila.positionlogic.com/" class="title text-dark">Servicio GPS</a></h5>
                            <p class="text-muted">Conoce y haz parte de nuestro nuevo club de clientes preferenciales</p>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-12 mt-4 pt-2">
                    <div class="bg-white features explore-feature servicios_index p-4 pt-5 px-md-3 border-0 rounded-md shadow text-center">
                        ...
                        <div class="card-body p-0 content">
                            <h5 class="mt-4"><a href="javascript:void(0)" data-toggle="modal" data-target="#mascota" class="title text-dark">Viaja con tu Mascota</a></h5>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-12 mt-4 pt-2">
                    <div class="bg-white features explore-feature servicios_index p-4 pt-5 px-md-3 border-0 rounded-md shadow text-center">
                        ...
                        <div class="card-body p-0 content">
                            <h5 class="mt-4"><a href="{{route('especial')}}" class="title text-dark">Servicio Especial</a></h5>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-12 mt-4 pt-2">
                    <div class="bg-white features explore-feature servicios_index p-4 pt-5 px-md-3 border-0 rounded-md shadow text-center">
                        ...
                        <div class="card-body p-0 content">
                            <h5 class="mt-4"><a href="{{route('turismo')}}" class="title text-dark">Agencia de Viajes</a></h5>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-12 mt-4 pt-2">
                    <div class="bg-white features explore-feature servicios_index p-4 pt-5 px-md-3 border-0 rounded-md shadow text-center">
                        ...
                        <div class="card-body p-0 content">
                            <h5 class="mt-4"><a href="{{route('estacion')}}" class="title text-dark">Estacion de Servicios</a></h5>
                        ...
                        <div class="accordion" id="accordionExample">
                            <div class="card border-0 rounded mb-2">
                                <a data-toggle="collapse" href="#collapseOne" class="faq position-relative" aria-expanded="true" aria-controls="collapseOne">
                                    <div class="card-header border-0 shadow bg-light p-3" id="headingOne">
                                        <h5 class="title mb-0">¿Qué debo hacer si no puedo viajar en la hora y/o fecha indicada?</h5>
                                    </div>
                                </a>
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                    <div class="card-body">
                                        <p class="text-muted mb-0 faq-ans">Debe avisarnos con al menos 4 horas de anterioridad a la programada de viaje por medio del correo clientes@cootranshuila.com o a la línea telefónica (8)875 6365 o (8)8756368 indicando dejar su tiquete abierto o la devolución del dinero.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-0 rounded mb-2">
                                <a data-toggle="collapse" href="#collapseTwo" class="faq position-relative collapsed" aria-expanded="false" aria-controls="collapseTwo">
                                    <div class="card-header border-0 shadow bg-light p-3" id="headingTwo">
                                        <h5 class="title mb-0">¿Cómo usar un tiquete en estado abierto y que lapso de tiempo tengo para poder usarlo?</h5>
                                    </div>
                                </a>
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                    <div class="card-body">
                                        <p class="text-muted mb-0 faq-ans">Para usar su tiquete abierto tiene un lapso de tiempo de 6 meses a partir de la fecha de compra y para hacerlo debe comunicarse con nosotros por medio del correo clientes@cootranshuila.com o a la línea telefónica (8)875 6365 o (8)8756368.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-0 rounded mb-2">
                                <a data-toggle="collapse" href="#collapseThree" class="faq position-relative collapsed" aria-expanded="false" aria-controls="collapseThree">
                                    <div class="card-header border-0 shadow bg-light p-3" id="headingfive">
                                        <h5 class="title mb-0">¿Me devuelven el dinero si definitivamente decido no viajar?</h5>
                                    </div>
                                </a>
                                <div id="collapseThree" class="collapse" aria-labelledby="headingfive" data-parent="#accordionExample">
                                    <div class="card-body">
                                        <p class="text-muted mb-0 faq-ans">Para la devolución del dinero tiene que enviarnos la solicitud al correo clientes@cootranshuila.com para validar los datos y hacer la devolución del valor del tiquete menos el 15%, esto por gastos operacionales.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-0 rounded mb-0">
                                <a data-toggle="collapse" href="#collapsefive" class="faq position-relative collapsed" aria-expanded="false" aria-controls="collapsefive">
                                    <div class="card-header border-0 shadow bg-light p-3" id="headingfive">
                                        <h5 class="title mb-0">¿Puedo viajar con mi mascota?</h5>
                                    </div>
                                </a>
                                <div id="collapsefive" class="collapse" aria-labelledby="headingfive" data-parent="#accordionExample">
                                    <div class="card-body">
                                        <p class="text-muted mb-0 faq-ans">En Cootranshuila está permitido únicamente el transporte de mascotas domésticas. Para ello debes tener en cuenta nuestras recomendaciones en pro de tu bienestar y el de ella. <a href="javascript:void(0)" class="text-dark font-weight-bold" data-toggle="modal" data-target="#mascota">Ver requisitos mínimos.</a> </p>
                                    </div>
                                </div>
                            </div>
                        </div>
